...
function print(data) {
  for(let a of data.results.shop){
    ...
    console.log(a.close);
    console.log(a.mobile_access);
  }
  let a = document.querySelector('input#guess');
  console.log('検索キー ' + a.value);
}
...
function sendRequest() {
  // URL を設定
  let i = document.querySelector('input[name="guess"]');
  i = i.value;          
  if (i == '居酒屋'){
    n = 'G001';
  } else if (i == 'ダイニングバー・バル'){
    n = 'G002';
  } else if (i == '創作料理'){
    n = 'G003';
  } else if (i == '和食'){
    ...
    n = 'G005';
  } else if (i == 'イタリアン・フレンチ'){
    n = 'G006';
  } else if (i == '中華'){
    n = 'G007';
  } else if (i == '焼肉・ホルモン'){
    n = 'G008';
  } else if (i == 'アジア・エスニック料理'){
    n = 'G009';
  } else if (i == '各国料理'){
    n = 'G010';
  } else if (i == 'カラオケ・パーティ'){
  ...
  let url = 'https://www.nishita-lab.org/web-contents/jsons/hotpepper/'+ n +'.json';
